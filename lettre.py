...
def draw_inputed_char():
    ...
    letter = input(chaine)
    while letter != 'quit':
        print("Vous avez saisi la lettre : ", letter)
        if letter == "a" or letter == "A":
            ...
            dessine_parenthese_ouvrante()
            up()
            forward(10)
            down()
            return 1
        elif letter == ')':
            dessine_parenthese_fermante()
            up()
            forward(10)
            down()
            return 1
        else:
            print("La lettre entrée n'est pas dans l'alphabet\n")
            letter = input(chaine)
    return 3
